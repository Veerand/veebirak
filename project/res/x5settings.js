...
x5engine.imQueue.push_init("x5engine.imMenu.setup({ target: '#imMnMn', verticalScroll: true, orientation: 'vertical', menuHeight: 36, submenuHeight: 36, opacity: 0.800, type: 'singleColumn', effect: 'none'})",false);
